...
function buildScenes(article: Article, script: VideoScript): any[] {
  ...
  scenes.push({
    ...
    voice: {
      ...
      volume: 0.9,
      speed: 1.15,
      emotion: 'excited'  // Add emotion for personality
    },
    caption_setting: {
      style: 'shout-block',
  ...
  scenes.push({
    character: {
      ...
      avatar_id: AVATAR_ID,
      avatar_style: 'normal',
      scale: 0.7,  // Larger avatar for middle scenes
    ...
    voice: {
      ...
      volume: 0.85,
      speed: 1.15,
      emotion: 'concerned'  // Add emotional variety
    },
    caption_setting: {
      style: 'shout-block',
      font_family: 'Montserrat',
  ...
  scenes.push({
    character: {
      ...
      avatar_id: AVATAR_ID,
      avatar_style: 'normal',
      scale: 0.75,  // Slightly larger for key educational point
    ...
    voice: {
      ...
      volume: 0.85,
      speed: 1.1,
      emotion: 'confident'  // Educational confidence
    },
    caption_setting: {
      style: 'shout-block',
      font_family: 'Montserrat',
