...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const checkoutSession = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.NEXT_PUBLIC_BASE_URL || process.env.NEXTAUTH_URL}/realtor-dashboard/settings?success=credit&credits=1`,
      cancel_url: `${process.env.NEXT_PUBLIC_BASE_URL || process.env.NEXTAUTH_URL}/realtor-dashboard/settings?canceled=true`,
    });
