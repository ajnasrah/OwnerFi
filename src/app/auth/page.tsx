      ...
      <div className="w-full max-w-md">
          ...
          {mode === 'email' ? (
            <form onSubmit={handleEmailSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#00BC7D] to-[#009B66] hover:from-[#00BC7D] hover:to-[#009B66] text-white py-4 px-6 rounded-xl font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {loading ? (
            ...
            <form onSubmit={handleCodeSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="w-full px-4 py-4 bg-[#111625]/50 border border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00BC7D] focus:border-transparent text-white text-2xl text-center tracking-widest placeholder-slate-500 transition-all"
                />
              </div>
              ...
              <button
                ...
                className="w-full text-[#00BC7D] hover:text-[#00d68f] text-sm font-semibold transition-colors"
              >
        ...
        <div className="mt-6 bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-xl p-4">
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 bg-[#00BC7D]/20 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-slate-400">
            ...
            <a
              ...
              className="text-[#00BC7D] hover:text-[#00d68f] underline transition-colors"
            >
              Terms of Service
            </a>
            {' '}and{' '}
