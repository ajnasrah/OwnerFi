...
const tutorialSteps = [
  {
    ...
    visual: (
      <div className="flex items-center justify-center gap-2 sm:gap-3 my-4">
        ...
        <div className="flex flex-col items-center">
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-500/20 rounded-xl flex items-center justify-center border border-emerald-500/30">
            <span className="text-xl sm:text-2xl">🤝</span>
          </div>
          <span className="text-[10px] text-emerald-400 mt-1 font-medium">Direct</span>
        </div>
        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-slate-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
        </svg>
  ...
  },
  {
    ...
    visual: (
      <div className="my-4 flex flex-col items-center">
        <div className="bg-emerald-600 rounded-2xl px-5 py-3 max-w-[240px] relative mb-3">
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 px-4 py-6 overflow-y-auto">
        <div className="bg-slate-800 text-white rounded-2xl shadow-2xl max-w-md w-full p-5 sm:p-6 relative animate-fadeInScale border border-slate-700/50">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={handleNext}
              className="flex-1 px-4 py-3.5 bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white rounded-xl font-bold transition-all text-sm active:scale-95"
            >
