...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Owner Financing Sacramento - Better Than Rent to Own',
    description: 'Find owner financed homes across Sacramento. Immediate ownership, no banks needed.',
  },
  alternates: {
    canonical: 'https://ownerfi.ai/sacramento-owner-financing',
  }
}

async function getSacramentoProperties() {
  try {
    const propertiesRef = collection(db, 'properties')
    const q = query(
      propertiesRef,
      where('isActive', '==', true),
      where('city', 'in', ['Sacramento', 'Downtown', 'Midtown', 'East Sacramento', 'Land Park', 'Natomas'])
    )
    ...
    console.error('Error fetching Sacramento properties:', error)
...
export default async function OwnerfinancingSacramento() {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Is owner financing better than rent to own in Sacramento?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! With owner financing in Sacramento, you get immediate ownership and build equity from day one. Rent to own requires years of renting before you can purchase. Owner financing gives you the deed right away with seller-held financing."
        }
      },
      {
        "@type": "Question",
        "name": "Can I get owner financing with bad credit in Sacramento?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Many Sacramento sellers offering owner financing are flexible with credit requirements. While some properties require credit checks, approximately 30% have no credit requirements and 50% work with buyers who have credit challenges."
        }
      },
      {
        "@type": "Question",
        "name": "What neighborhoods in Sacramento offer owner financed homes?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Owner financed homes are available throughout Sacramento including Downtown, Midtown, East Sacramento, Land Park, Natomas, and more."
        }
      },
      {
        "@type": "Question",
        "name": "How much down payment is needed for Sacramento owner financing?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Down payments in Sacramento typically range from 10% to 20% of the purchase price. California's market makes owner financing accessible with reasonable terms."
        }
      }
    ]
  }
  ...
  const localBusinessSchema = {
    ...
    "areaServed": {
      ...
      "containsPlace": [
        ...
        { "@type": "Neighborhood", "name": "East Sacramento" },
        { "@type": "Neighborhood", "name": "Land Park" },
        { "@type": "Neighborhood", "name": "Natomas" }
      ]
    }
  }
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <nav className="mb-8">
            <ol className="flex space-x-2 text-sm text-slate-600">
              ...
              <li>/</li>
              <li className="text-slate-900 font-medium">Sacramento</li>
            </ol>
          </nav>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
              Owner Financing Sacramento - Better Than Rent to Own
            </h1>
            <p className="text-xl text-slate-700 mb-8">
              Find {totalCount > 0 ? `${totalCount}+ ` : ''}owner financed homes across California Capital.
              Skip the banks and get immediate ownership with seller financing in Downtown, Midtown, East Sacramento, and beyond.
            </p>
          ...
          <section className="py-12 px-6 bg-gradient-to-r from-green-900/30 to-[#004D33]/30 rounded-2xl mb-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">
                Browse owner financed and rent-to-own properties across Sacramento.
          ...
          {/* Sacramento Neighborhoods Section */}
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-8">
              Owner Financed Homes by Sacramento Neighborhood
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="p-6 bg-gradient-to-br from-purple-50 to-purple-50 rounded-xl border-2 border-purple-200">
                ...
                <p className="text-purple-700 mb-2">
                  {areaCounts['East Sacramento'] || 'Premium'} owner financed properties
                </p>
              ...
              <div className="p-6 bg-gradient-to-br from-teal-50 to-teal-50 rounded-xl border-2 border-teal-200">
                ...
                <p className="text-teal-700 mb-2">
                  {areaCounts['Natomas'] || 'Premium'} owner financed properties
                </p>
          ...
          {/* Why Owner Financing in Sacramento */}
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Why Choose Owner Financing in Sacramento?
            </h2>

            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">
                  Sacramento Real Estate Advantages
                </h3>
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Great location and lifestyle in Sacramento</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">
                  Owner Financing vs Rent to Own in Sacramento
                </h3>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-8">
              Sacramento Owner Financing FAQ
            </h2>

            <div className="space-y-6">
              <div className="border-b pb-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  Is owner financing legal in Sacramento?
                </h3>
                <p className="text-slate-700">
                  Yes, owner financing is completely legal in Sacramento. The city follows California state laws governing
              ...
              <div className="border-b pb-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  What credit score do I need for owner financing in Sacramento?
                </h3>
                <p className="text-slate-700">
                  Credit requirements vary by seller. Approximately 30% of our Sacramento properties have
              ...
              <div className="border-b pb-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  How much down payment is typical for Sacramento owner financing?
                </h3>
                <p className="text-slate-700">
                  Down payments typically range from 10% to 20% of the purchase price in Sacramento.
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  Can I use owner financing for Sacramento investment properties?
                </h3>
                <p className="text-slate-700">
                  Yes! Many Sacramento sellers offer owner financing for investment properties.
