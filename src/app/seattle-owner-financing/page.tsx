...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Owner Financing Seattle - Better Than Rent to Own',
    description: 'Find owner financed homes across Seattle. Immediate ownership, no banks needed.',
  },
  alternates: {
    canonical: 'https://ownerfi.ai/seattle-owner-financing',
  }
}

async function getSeattleProperties() {
  try {
    const propertiesRef = collection(db, 'properties')
    const q = query(
      propertiesRef,
      where('isActive', '==', true),
      where('city', 'in', ['Seattle', 'Downtown', 'Capitol Hill', 'Ballard', 'Fremont', 'Queen Anne'])
    )
    ...
    console.error('Error fetching Seattle properties:', error)
...
export default async function OwnerfinancingSeattle() {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Is owner financing better than rent to own in Seattle?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes! With owner financing in Seattle, you get immediate ownership and build equity from day one. Rent to own requires years of renting before you can purchase. Owner financing gives you the deed right away with seller-held financing."
        }
      },
      {
        "@type": "Question",
        "name": "Can I get owner financing with bad credit in Seattle?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Many Seattle sellers offering owner financing are flexible with credit requirements. While some properties require credit checks, approximately 30% have no credit requirements and 50% work with buyers who have credit challenges."
        }
      },
      {
        "@type": "Question",
        "name": "What neighborhoods in Seattle offer owner financed homes?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Owner financed homes are available throughout Seattle including Downtown, Capitol Hill, Ballard, Fremont, Queen Anne, and more."
        }
      },
      {
        "@type": "Question",
        "name": "How much down payment is needed for Seattle owner financing?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Down payments in Seattle typically range from 10% to 20% of the purchase price. Washington's market makes owner financing accessible with reasonable terms."
        }
      }
    ]
  }
  ...
  const localBusinessSchema = {
    ...
    "areaServed": {
      ...
      "containsPlace": [
        ...
        { "@type": "Neighborhood", "name": "Ballard" },
        { "@type": "Neighborhood", "name": "Fremont" },
        { "@type": "Neighborhood", "name": "Queen Anne" }
      ]
    }
  }
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <nav className="mb-8">
            <ol className="flex space-x-2 text-sm text-slate-600">
              ...
              <li>/</li>
              <li><Link href="/owner-financing-washington" className="hover:text-indigo-600">Washington</Link></li>
              <li>/</li>
              <li className="text-slate-900 font-medium">Seattle</li>
            </ol>
          </nav>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
              Owner Financing Seattle - Better Than Rent to Own
            </h1>
            <p className="text-xl text-slate-700 mb-8">
              Find {totalCount > 0 ? `${totalCount}+ ` : ''}owner financed homes across Emerald City.
              Skip the banks and get immediate ownership with seller financing in Downtown, Capitol Hill, Ballard, and beyond.
            </p>
          ...
          <section className="py-12 px-6 bg-gradient-to-r from-green-900/30 to-[#004D33]/30 rounded-2xl mb-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-300 mb-8">
                Browse owner financed and rent-to-own properties across Seattle.
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-8">
              Owner Financed Homes by Seattle Neighborhood
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-50 rounded-xl border-2 border-blue-200">
                ...
                <p className="text-blue-700 mb-2">
                  {areaCounts['Capitol Hill'] || 'Premium'} owner financed properties
                </p>
              ...
              <div className="p-6 bg-gradient-to-br from-purple-50 to-purple-50 rounded-xl border-2 border-purple-200">
                ...
                <p className="text-purple-700 mb-2">
                  {areaCounts['Ballard'] || 'Premium'} owner financed properties
                </p>
              ...
              <div className="p-6 bg-gradient-to-br from-teal-50 to-teal-50 rounded-xl border-2 border-teal-200">
                ...
                <p className="text-teal-700 mb-2">
                  {areaCounts['Queen Anne'] || 'Premium'} owner financed properties
                </p>
          ...
          {/* Why Owner Financing in Seattle */}
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">
              Why Choose Owner Financing in Seattle?
            </h2>

            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">
                  Seattle Real Estate Advantages
                </h3>
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Great location and lifestyle in Seattle</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">
                  Owner Financing vs Rent to Own in Seattle
                </h3>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-green-800 text-sm">
                      ...
                      Washington property tax benefits. Protected by state property laws.
                    </p>
                  </div>
                  <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                    ...
                    <p className="text-red-800 text-sm">
                      ...
                      Risk of losing option fee. Treated as tenant under Washington law.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-8">
              Seattle Owner Financing FAQ
            </h2>

            <div className="space-y-6">
              <div className="border-b pb-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  Is owner financing legal in Seattle?
                </h3>
                <p className="text-slate-700">
                  Yes, owner financing is completely legal in Seattle. The city follows Washington state laws governing
              ...
              <div className="border-b pb-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  What credit score do I need for owner financing in Seattle?
                </h3>
                <p className="text-slate-700">
                  Credit requirements vary by seller. Approximately 30% of our Seattle properties have
              ...
              <div className="border-b pb-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  How much down payment is typical for Seattle owner financing?
                </h3>
                <p className="text-slate-700">
                  Down payments typically range from 10% to 20% of the purchase price in Seattle.
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  Can I use owner financing for Seattle investment properties?
                </h3>
                <p className="text-slate-700">
                  Yes! Many Seattle sellers offer owner financing for investment properties.
