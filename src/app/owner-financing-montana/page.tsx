          ...
          <section className="relative py-20 px-6 bg-gradient-to-b from-green-900/20 to-slate-900">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Link href="/auth" className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all">
