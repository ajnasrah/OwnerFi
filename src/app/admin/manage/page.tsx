                            ...
                            <div className="flex items-center space-x-8">
                              ...
                              {realtor.phone && (
                                <div className="flex items-center space-x-2">
                                  ...
                                  <a
                                    href={`sms:${realtor.phone}`}
                                    className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-600/20 text-blue-400 hover:bg-blue-600/40 transition-colors"
                                    aria-label={`Text ${realtor.name}`}
                                    title={`Text ${realtor.name}`}
                                  >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
