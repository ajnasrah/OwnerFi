...
export default function ABTestsPage() {
  const [selectedBrand, setSelectedBrand] = useState<'carz' | 'ownerfi' | 'benefit' | 'abdullah' | 'gaza' | 'realtors'>('carz');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-2 mb-6">
          {(['carz', 'ownerfi', 'benefit', 'abdullah', 'gaza', 'realtors'] as const).map((brand) => (
            <button
              key={brand}
