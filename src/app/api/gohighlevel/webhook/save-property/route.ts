...
export async function POST(request: NextRequest) {
  try {
    ...
    const payload: GHLPropertyPayload = {
      ...
      propertyAddress: request.headers.get('propertyaddress') || request.headers.get('propertyAddress') || bodyData.propertyAddress || bodyData.address || bodyData.street_address || '',
      propertyCity: request.headers.get('propertycity') || request.headers.get('propertyCity') || bodyData.propertyCity || bodyData.city || '',
      state: request.headers.get('state') || bodyData.state || bodyData.propertyState || '',
      zipCode: request.headers.get('zipcode') || request.headers.get('zipCode') || bodyData.zipCode || bodyData.zip || bodyData.zipcode || bodyData.propertyZip || '',
      price: request.headers.get('price') || bodyData.price || bodyData.propertyPrice || '0',
      bedrooms: request.headers.get('bedrooms') || bodyData.bedrooms || bodyData.beds || bodyData.propertyBeds || '',
      bathrooms: request.headers.get('bathrooms') || bodyData.bathrooms || bodyData.baths || bodyData.propertyBaths || '',
      livingArea: request.headers.get('livingarea') || request.headers.get('livingArea') || bodyData.livingArea || bodyData.squareFeet || bodyData.propertySquareFeet || bodyData.square_foot || '',
      yearBuilt: request.headers.get('yearbuilt') || request.headers.get('yearBuilt') || bodyData.yearBuilt || bodyData.year_built || '',
      lotSizes: request.headers.get('lotsizes') || request.headers.get('lotSizes') || bodyData.lotSizes || bodyData.lotSize || bodyData.lot_square_foot || '',
      homeType: request.headers.get('hometype') || request.headers.get('homeType') || bodyData.homeType || bodyData.propertyType || bodyData.building_type || 'SINGLE_FAMILY',
      imageLink: request.headers.get('imagelink') || request.headers.get('imageLink') || bodyData.imageLink || bodyData.image || bodyData.imageUrl || bodyData.imgSrc || bodyData.property_image || '',
