        ...
        <div className="max-w-7xl mx-auto px-4 py-2.5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Link
                href="/dashboard/settings"
                className="w-8 h-8 bg-white/5 hover:bg-white/10 rounded-full flex items-center justify-center transition-all border border-white/10"
              >
              ...
              <button
                ...
                className="w-8 h-8 bg-red-500/10 hover:bg-red-500/20 rounded-full flex items-center justify-center transition-all border border-red-500/30"
                title="Sign Out"
              >
