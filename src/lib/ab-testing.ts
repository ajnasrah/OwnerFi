 ...
 */
export async function getTestsForBrand(brand: 'carz' | 'ownerfi' | 'benefit' | 'abdullah' | 'personal' | 'gaza' | 'realtors'): Promise<ABTest[]> {
  if (!db) throw new Error('Firebase not initialized');
 ...
 */
export async function createHookTest(brand: 'carz' | 'ownerfi' | 'benefit' | 'abdullah' | 'personal' | 'gaza' | 'realtors'): Promise<string> {
  return createABTest({
 ...
 */
export async function createCaptionTest(brand: 'carz' | 'ownerfi' | 'benefit' | 'abdullah' | 'personal' | 'gaza' | 'realtors'): Promise<string> {
  return createABTest({
 ...
 */
export async function createPostingTimeTest(brand: 'carz' | 'ownerfi' | 'benefit' | 'abdullah' | 'personal' | 'gaza' | 'realtors'): Promise<string> {
  return createABTest({
